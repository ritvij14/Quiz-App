...
class Practice : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainBinding.btnOptionB.setOnClickListener{
            mainBinding.btnOptionB.setBackgroundColor(Color.YELLOW)
        }
        mainBinding.btnOptionC.setOnClickListener{
            mainBinding.btnOptionC.setBackgroundColor(Color.YELLOW)
        }
        mainBinding.btnOptionD.setOnClickListener{
            mainBinding.btnOptionD.setBackgroundColor(Color.YELLOW)
        }


        mainBinding.btnNext.setOnClickListener{
            mainBinding.btnOptionA.setBackgroundColor(Color.WHITE)
            mainBinding.btnOptionB.setBackgroundColor(Color.WHITE)
            mainBinding.btnOptionC.setBackgroundColor(Color.WHITE)
            mainBinding.btnOptionD.setBackgroundColor(Color.WHITE)
